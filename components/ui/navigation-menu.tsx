...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{" "}
      <ChevronDownIcon
        className="relative top-[1px] ml-1 size-4 transition duration-300 group-data-[state=open]:rotate-180 text-secondary"
        aria-hidden="true"
      />
    </NavigationMenuPrimitive.Trigger>
  )
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        ...
        "absolute left-0 top-full mt-2 min-w-[200px] z-[100] rounded-b-4xl p-4 bg-white shadow-xl border border-gray-200",
